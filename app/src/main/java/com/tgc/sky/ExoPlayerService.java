...
class ExoplayerService {
    ...
    @OptIn(markerClass = UnstableApi.class) public void Initialize(Context context) {
    ...
    @OptIn(markerClass = UnstableApi.class) public void LoadUrl(String str) {
        EndVideo();
    ...
    @OptIn(markerClass = UnstableApi.class) void Update() {
    ...
    @OptIn(markerClass = UnstableApi.class) ExoplayerVideoMetadata GetMetadata() {
    ...
    HardwareBuffer GetNextHardwareBuffer() {
