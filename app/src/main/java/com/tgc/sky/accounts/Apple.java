...
public class Apple implements SystemAccountInterface {
    ...
    public void Initialize(GameActivity gameActivity, SystemAccountInterface.UpdateClientInfoCallback updateClientInfoCallback) {
        ...
        systemAccountClientInfo.accountType = SystemAccountType.kSystemAccountType_Apple;
        ...
        systemAccountServerInfo.type = SystemAccountType.kSystemAccountType_Apple;
